        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <div class="flex flex-col items-center">
                    ...
                    {{-- Moraws Logo --}}
                    <svg class="w-full max-w-none transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6"
                        viewBox="0 0 9525 1719.78" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    {{-- Light Mode JM SVG --}}
                    <svg class="w-[400px] max-w-none mx-auto mt-4 dark:hidden" viewBox="0 0 440 376" fill="none"
                    ...
                    {{-- Dark Mode JM SVG --}}
                    <svg class="w-[448px] max-w-none mx-auto mt-4 hidden dark:block" viewBox="0 0 440 376"
