...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-end mb-6 space-x-4">
        <button wire:click="exportData" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition">
            Exportar Dados
        </button>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="flex flex-col rounded-lg bg-white dark:bg-gray-800 shadow-sm max-w-96 p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="p-0">
                <ul class="flex flex-col gap-3">
                    <li class="flex items-center gap-3">
                        <span class="p-1 border rounded-full border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-sm">
                            <span class="font-semibold">Total de Terreiros:</span> <span class="font-bold text-base">{{ $terreirosCount }}</span>
                        </p>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="p-1 border rounded-full border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-sm">
                            <span class="font-semibold">Total Conv. (Terreiros):</span> <span class="font-bold text-base">{{ $convidadosCount }}</span>
                        </p>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="p-1 border rounded-full border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-sm">
                            <span class="font-semibold">Total de Instituições:</span> <span class="font-bold text-base">{{ $instituicoesCount }}</span>
                        </p>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="p-1 border rounded-full border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-sm">
                            <span class="font-semibold">Total Conv. (Instituições):</span> <span class="font-bold text-base">{{ $instituicoesConvidados }}</span>
                        </p>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="p-1 border rounded-full border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-sm">
                            <span class="font-semibold">Total Geral T.+I.:</span> <span class="font-bold text-lg">{{ $totalGeralTerreirosInstituicoes }}</span>
                        </p>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="p-1 border rounded-full border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 text-sm">
                            <span class="font-semibold">Total Convidados:</span> <span class="font-bold text-lg">{{ $totalConvidadosGeral }}</span>
                        </p>
                    </li>
                </ul>
            </div>
